...
echo '    <span class="badge bg-warning bg-opacity-10 text-warning border border-warning border-opacity-25 px-3">Miner: <small class="font-monospace">'.htmlspecialchars($user->username).'</small></span>';
echo '  </div>';
...
foreach($db_blocks as $db_block)
{
	...
	echo ' <small class="text-muted text-uppercase">('.htmlspecialchars($coin->algo).')</small>'.$flags.'</td>';
